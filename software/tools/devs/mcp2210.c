...
int
mcp2210_spi_transfer (int fd, mcp2210_packet spi_packet, uint8_t *data, short len)
{
    int rd = 0, wr = 0;
...
retry:
        ...
        switch (packet[3]) {
        case MCP2210_SPI_STARTED:   //0x20 – SPI transfer started – no data to receive
        case MCP2210_SPI_END:       //0x10 – SPI Transfer Engine Status: SPI transfer finished – no more data to send
        case MCP2210_SPI_DATA:      //0x30 – SPI Transfer Engine Status: SPI transfer not finished; received data available
            break;
        default:
