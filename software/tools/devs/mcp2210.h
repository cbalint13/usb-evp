...
#define MCP2210_CHIP_GP6_CNT_HI_PULSE   0x04
#define MCP2210_CHIP_GP6_CNT_LO_PULSE   0x03
#define MCP2210_CHIP_GP6_CNT_UP_EDGE    0x02
#define MCP2210_CHIP_GP6_CNT_DN_EDGE    0x01
#define MCP2210_CHIP_GP6_CNT_NONE       0x00
...
int mcp2210_spi_transfer (int fd, mcp2210_packet spi_packet, uint8_t *data, short len);
